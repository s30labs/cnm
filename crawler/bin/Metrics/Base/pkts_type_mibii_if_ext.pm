#####################################################################################################
# Fichero: (Metrics::Base::pkts_type_mibii_if_ext.pm)   $Id$
# Descripcion: Metrics::Base::pkts_type_mibii_if_ext.pm
# Set Tab=3
#####################################################################################################
package Metrics::Base::pkts_type_mibii_if_ext;
$VERSION='1.00';
use strict;
use Crawler::SNMP;
...
';
   ...
   #%Metrics::Base::Desc=();
	$Metrics::Base::Info='';
   $snmpcfg{oid}='ifDescr_ifType_ifInUcastPkts_ifInNUcastPkts_ifOutUcastPkts_ifOutNUcastPkts';
