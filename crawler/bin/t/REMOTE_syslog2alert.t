...
my $log_level='debug';
my $cid='default';
my $trap_manager=Crawler::LogManager::Syslog->new(store_path=>$store_path, host_idx=>$host_idx, host=>$host, cfg=>$rCFG, log_level=>$log_level, data_path=>$data_path, cid=>$cid, cid_ip=>$ip );
