...
#-------------------------------------------------------------------------------------------
my $table = 'logp_333333000011_VTOM_TJS4EDIINVACK_from_mail';
my $ip = '10.50.100.44';
my $id_dev = 48;
my $logfile = 'VTOM_TJS4EDIINVACK_from_mail';
my $source = '333333000011';

my %data=('id_dev'=>$id_dev,'id_credential'=>1,'logfile'=>$logfile,'tabname'=>$table,'todb'=>1,'status'=>0,'app_id'=>$source);


#-------------------------------------------------------------------------------------------
my $r1=$store->init_device2log($dbh,\%data);

my $r2=$store->create_log_table($dbh,$table,$ip);
