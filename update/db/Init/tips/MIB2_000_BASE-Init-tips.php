<?php
      $TIPS[]=array(
         'id_ref' => 'mib2_ipInAddrErrors',	'tip_type' => 'cfg',	'url' => '',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'mib2_ipRoutingDiscards',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'mib2_ipOutNoRoutes',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'mib2_uptime',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'mib2_glob_ifstat',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
         'descr' => 'Mide: <strong>up|admin down|down|unk</strong> a partir de los siguientes atributos de la mib RFC1213-MIB:<br><br><strong>RFC1213-MIB::ifAdminStatus (GAUGE):</strong> "The desired state of the interface.  The
             testing(3) state indicates that no operational
             packets can be passed."
<strong>RFC1213-MIB::ifOperStatus (GAUGE):</strong> "The current operational state of the interface.
