<?php
      $TIPS[]=array(
         'id_ref' => 'ns_cpu_usage_perc',	'tip_type' => 'cfg',	'url' => '',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ns_mem_usage',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ns_session_usage',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ns_active_users',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ns_url_filter_stat',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ns_power_status',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ns_slot_status',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ns_tunnel_status',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
