<?php
      $TIPS[]=array(
         'id_ref' => 'fortigate_cpu_usage',	'tip_type' => 'cfg',	'url' => '',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'fortigate_mem_usage',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'fortigate_lowmem_usage',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'fortigate_disk_usage',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'fortigate_ses_count',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'fortigate_pol_traffic',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
