<?php
      ...
      $TIPS[]=array(
         ...
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
         'descr' => 'Mide: <strong>vmMemSize</strong> a partir de los siguientes atributos de la mib VMWARE-VMINFO-MIB:<br><br><strong>VMWARE-VMINFO-MIB::vmMemSize (GAUGE):</strong> ',
      );
      ...
      $TIPS[]=array(
         ...
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
         'descr' => 'Mide: <strong>running|notRunning</strong> a partir de los siguientes atributos de la mib VMWARE-VMINFO-MIB:<br><br><strong>VMWARE-VMINFO-MIB::vmGuestState (GAUGE):</strong> ',
      );
      ...
      $TIPS[]=array(
         ...
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
         'descr' => 'Mide: <strong>running|notRunning</strong> a partir de los siguientes atributos de la mib VMWARE-VMINFO-MIB:<br><br><strong>VMWARE-VMINFO-MIB::vmGuestState (GAUGE):</strong> <strong>VMWARE-VMINFO-MIB::vmMemSize (GAUGE):</strong> ',
      );
