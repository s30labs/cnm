<?php
      $TIPS[]=array(
         'id_ref' => 'app_airspace_apifinfo_table',  'tip_type' => 'app', 'url' => '',
         'date' => 1430853634,     'tip_class' => 1, 'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'app_airspace_apinfo_table',  'tip_type' => 'app', 'url' => '',
         'date' => 1430853634,     'tip_class' => 1, 'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'app_airspace_apload_table',  'tip_type' => 'app', 'url' => '',
         'date' => 1430853634,     'tip_class' => 1, 'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'app_airspace_approfiles_table',  'tip_type' => 'app', 'url' => '',
         'date' => 1430853634,     'tip_class' => 1, 'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'app_airspace_mobinfo_table',  'tip_type' => 'app', 'url' => '',
         'date' => 1430853634,     'tip_class' => 1, 'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'app_airspace_rogueinfo_table',  'tip_type' => 'app', 'url' => '',
         'date' => 1430853634,     'tip_class' => 1, 'name' => 'Descripcion',
