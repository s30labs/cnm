<?php
      $TIPS[]=array(
         'id_ref' => 'PRAVAIL-MIB::subHostDown',  'tip_type' => 'remote', 'url' => '',
...
<br>OCTET STRING (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PRAVAIL-MIB::pravailProtectionGroupError',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PRAVAIL-MIB::pravailConfigMissing',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PRAVAIL-MIB::pravailConfigError',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PRAVAIL-MIB::pravailHwDeviceDown',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PRAVAIL-MIB::pravailHwSensorCritical',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PRAVAIL-MIB::pravailSwComponentDown',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PRAVAIL-MIB::pravailSystemStatusCritical',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PRAVAIL-MIB::pravailSystemStatusDegraded',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PRAVAIL-MIB::pravailFilesystemCritical',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PRAVAIL-MIB::pravailGRETunnelFailure',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PRAVAIL-MIB::pravailNextHopUnreachable',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PRAVAIL-MIB::pravailPerformance',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PRAVAIL-MIB::pravailSystemStatusError',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PRAVAIL-MIB::pravailCloudSignalTimeout',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PRAVAIL-MIB::pravailCloudSignalThreshold',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PRAVAIL-MIB::pravailTrapTraffic',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PRAVAIL-MIB::pravailTrapBotnetAttack',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PRAVAIL-MIB::pravailTrapLicenseLimit',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PRAVAIL-MIB::pravailTrapBlockedTraffic',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
