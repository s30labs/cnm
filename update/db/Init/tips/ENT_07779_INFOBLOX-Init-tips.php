<?php
      $TIPS[]=array(
         'id_ref' => 'ib_dns_nonaa_lat',	'tip_type' => 'cfg',	'url' => '',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_dns_nonaa_cnt',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_dns_aa_lat',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_dns_aa_cnt',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_cpu_temperature',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_cpu_usage',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_mem_usage',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_dns_monitor',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_dhcp_disc_req',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_dhcp_rel_off',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_dhcp_ack_nack',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_dhcp_other',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_dhcp',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_dns',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_ntp',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_radius',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_tftp',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_httpf',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_ftp',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_btools_move',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_btools',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_node',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_disk',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_lan1',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_lan2',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_lan_ha',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_lan_mgmt',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_lcd',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_mem',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_repli',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_dbobj',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_raid_sum',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_raid_disk1',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_raid_disk2',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_raid_disk3',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_raid_disk4',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_fan1',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_fan2',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_fan3',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_power',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_ntp_sync',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_cpu1_temp',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_cpu2_temp',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_sys_temp',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_raid_bat',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_cpu_usage',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_ospf',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ib_status_bgp',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
