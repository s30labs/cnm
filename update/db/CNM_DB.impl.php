 ...
 *   DB::Connect()            4 usos  →  CNM_DB::Connect()
 *   PEAR::isError()        ~89 usos  →  CNM_isError()               [función global]
 *
 ...
 *   2. DB::Connect($p, TRUE)     →  CNM_DB::Connect($p, true)
 *   3. @PEAR::isError($x)        →  CNM_isError($x)
...
// Reemplaza PEAR::isError() y DB::isError() (~89 usos en el código)
// =============================================================================
...
class CNM_DB
{
     ...
     *   if (@PEAR::isError($dbc)) { depura('error', $dbc->getMessage()); }
     *
     ...
     *   El código original usa @PEAR::isError(). Con este wrapper el @
...
DB-Scheme-Lib.php:
  ...
  2. $enlace = @DB::Connect($db_params, TRUE)
     → $enlace = CNM_DB::Connect($db_params, true)

  3. @PEAR::isError($x)  →  CNM_isError($x)   [~30 ocurrencias]
     grep -n "PEAR::isError" DB-Scheme-Lib.php
     sed -i 's/@PEAR::isError/CNM_isError/g' DB-Scheme-Lib.php
...
mysql_session.inc:
  ...
  2. @DB::Connect($dsn, TRUE)  →  CNM_DB::Connect($dsn, true)
  3. @PEAR::isError($x)  →  CNM_isError($x)   [9 ocurrencias]
...
Store.php:
  ...
  2. @PEAR::isError($x)  →  CNM_isError($x)   [50 ocurrencias]
     sed -i 's/@PEAR::isError/CNM_isError/g' Store.php
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  grep -rn "PEAR::\|DB::Connect\|require.*pear\|require.*DB\.php" \
