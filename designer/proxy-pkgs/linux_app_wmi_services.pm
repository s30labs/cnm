package linux_app_wmi_services;
...
# 0 METRICA  1=>APP
#---------------------------------------------------------------------------
$linux_app_wmi_services::CFG = 1;
$linux_app_wmi_services::SCRIPT_NAME = 'linux_app_wmi_services.pl';
...
#---------------------------------------------------------------------------
%linux_app_wmi_services::SCRIPT = (

	'__SCRIPT__' => $linux_app_wmi_services::SCRIPT_NAME,
   '__EXEC_MODE__' => 1,
   '__SCRIPT_DESCRIPTION__' => '',  # creo que sobra ¿?
   '__PROXY_TYPE__' => 'linux',
   '__CFG__' => $linux_app_wmi_services::CFG,
   ...
   '__TIMEOUT__' => 3600,
	...
	'__SCRIPT_PARAMS__' => {
		...
		'p01' => { '__HPARAM__' => '', '__PARAM_TYPE__' => '2', '__PARAM_PREFIX__' => '-n', '__PARAM_DESCR__' => 'IP', '__PARAM_VALUE__' => '', '__SCRIPT__' => $linux_app_wmi_services::SCRIPT_NAME },
		'p02' => { '__HPARAM__' => '', '__PARAM_TYPE__' => '0', '__PARAM_PREFIX__' => '-u', '__PARAM_DESCR__' => 'User', '__PARAM_VALUE__' => '', '__SCRIPT__' => $linux_app_wmi_services::SCRIPT_NAME },
		'p03' => { '__HPARAM__' => '', '__PARAM_TYPE__' => '1', '__PARAM_PREFIX__' => '-p', '__PARAM_DESCR__' => 'Clave', '__PARAM_VALUE__' => '', '__SCRIPT__' => $linux_app_wmi_services::SCRIPT_NAME },
	...
	# ----------------------------
	'__TIP__'  => {
		'__DESCR_TIP__' => 'Este escript muestra los servicios definidos en el equipo Windows a partir de los datos proporcionados por la clase WMI Win32_Service. Sus parámetros de ejecución son:<br>
cnm@cnm:/opt/cnm/xagent/base# ./linux_app_wmi_services.pl -h<br>
linux_app_wmi_services.pl 1.0<br>
<br>
linux_app_wmi_services.pl -n IP -u user -p pwd [-d domain]<br>
linux_app_wmi_services.pl -n IP -u domain/user -p pwd<br>
linux_app_wmi_services.pl -h  : Ayuda<br>
<br>
-n    IP remota<br>
-u    user<br>
-p    pwd<br>
...
-h    Ayuda<br>
',
		'__ID_REF__' => $linux_app_wmi_services::SCRIPT_NAME
	}
);
...
@linux_app_wmi_services::METRICS = (
...
# ahora no tiene uso
#---------------------------------------------------------------------------
@linux_app_wmi_services::APPS = (

   #------------------------------------------------------------------------
   {
      '__SUBTYPE__'=> 'Win', '__ANAME__'=> 'app_get_services',
      '__NAME__'=> 'OBTENER LOS SERVICIOS WINDOWS',
      '__DESCR__'=> '',
		'__CMD__'=> '',
      ...
      '__APP_PARAMS__' => {
         ...
         'p01' => { '__ENABLE__' => '1', '__VALUE__' => '', '__SCRIPT__' => $linux_app_wmi_services::SCRIPT_NAME },
         'p02' => { '__ENABLE__' => '1', '__VALUE__' => '$sec.wmi.user', '__SCRIPT__' => $linux_app_wmi_services::SCRIPT_NAME },
         'p03' => { '__ENABLE__' => '1', '__VALUE__' => '$sec.wmi.pwd', '__SCRIPT__' => $linux_app_wmi_services::SCRIPT_NAME },
      },
      # ----------------------------
      '__TIP__'  => {
         '__DESCR_TIP__' => 'Obtiene los servicios definidos en la maquina Windows',
      },
