package linux_app_wmi_EventLog;
...
# 0 METRICA  1=>APP
#---------------------------------------------------------------------------
$linux_app_wmi_EventLog::CFG = 1;
$linux_app_wmi_EventLog::SCRIPT_NAME = 'linux_app_wmi_EventLog.pl';
...
#---------------------------------------------------------------------------
%linux_app_wmi_EventLog::SCRIPT = (

	'__SCRIPT__' => $linux_app_wmi_EventLog::SCRIPT_NAME,
   '__EXEC_MODE__' => 1,
   '__SCRIPT_DESCRIPTION__' => '',  # creo que sobra ¿?
   '__PROXY_TYPE__' => 'linux',
   '__CFG__' => $linux_app_wmi_EventLog::CFG,
   ...
   '__TIMEOUT__' => 3600,
	...
	'__SCRIPT_PARAMS__' => {
		...
		'p01' => { '__HPARAM__' => '', '__PARAM_TYPE__' => '2', '__PARAM_PREFIX__' => '-n', '__PARAM_DESCR__' => 'IP', '__PARAM_VALUE__' => '', '__SCRIPT__' => $linux_app_wmi_EventLog::SCRIPT_NAME },
		'p02' => { '__HPARAM__' => '', '__PARAM_TYPE__' => '0', '__PARAM_PREFIX__' => '-u', '__PARAM_DESCR__' => 'User', '__PARAM_VALUE__' => '', '__SCRIPT__' => $linux_app_wmi_EventLog::SCRIPT_NAME },
		'p03' => { '__HPARAM__' => '', '__PARAM_TYPE__' => '1', '__PARAM_PREFIX__' => '-p', '__PARAM_DESCR__' => 'Clave', '__PARAM_VALUE__' => '', '__SCRIPT__' => $linux_app_wmi_EventLog::SCRIPT_NAME },
	...
	# ----------------------------
	'__TIP__'  => {
		'__DESCR_TIP__' => 'Este escript permite obtener los registros del visor de eventos de WIndows mediante la clase WMI Win32_NTLogEvent. Sus parámetros de ejecución son:<br>
...
',
		'__ID_REF__' => $linux_app_wmi_EventLog::SCRIPT_NAME
	}
);
...
@linux_app_wmi_EventLog::METRICS = (
...
# ahora no tiene uso
#---------------------------------------------------------------------------
@linux_app_wmi_EventLog::APPS = (

   #------------------------------------------------------------------------
   {
      '__SUBTYPE__'=> 'Win', '__ANAME__'=> 'app_get_event_log',
      '__NAME__'=> 'OBTENER ENTRADAS DEL VISOR DE EVENTOS',
      '__DESCR__'=> '',
		'__CMD__'=> '',
      ...
      '__APP_PARAMS__' => {
         ...
         'p01' => { '__ENABLE__' => '1', '__VALUE__' => '', '__SCRIPT__' => $linux_app_wmi_EventLog::SCRIPT_NAME },
         'p02' => { '__ENABLE__' => '1', '__VALUE__' => '$sec.wmi.user', '__SCRIPT__' => $linux_app_wmi_EventLog::SCRIPT_NAME },
         'p03' => { '__ENABLE__' => '1', '__VALUE__' => '$sec.wmi.pwd', '__SCRIPT__' => $linux_app_wmi_EventLog::SCRIPT_NAME },
      },
      # ----------------------------
      '__TIP__'  => {
         '__DESCR_TIP__' => 'Obtiene las entradas especificadas del visor de eventos de Windows. Válido para sistemas Windows',
      },
