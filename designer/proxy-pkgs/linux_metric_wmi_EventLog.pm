...
# 0 METRICA  1=>APP
#---------------------------------------------------------------------------
$linux_metric_wmi_EventLog::CFG = 0;
$linux_metric_wmi_EventLog::SCRIPT_NAME = 'linux_metric_wmi_EventLog.pl';
...
#---------------------------------------------------------------------------
%linux_metric_wmi_EventLog::SCRIPT = (

	'__SCRIPT__' => $linux_metric_wmi_EventLog::SCRIPT_NAME,
   '__EXEC_MODE__' => 1,
   '__SCRIPT_DESCRIPTION__' => '',  # creo que sobra ¿?
   '__PROXY_TYPE__' => 'linux',
   '__CFG__' => $linux_metric_wmi_EventLog::CFG,
   ...
   '__TIMEOUT__' => 30,
	...
	'__SCRIPT_PARAMS__' => {
		...
		'p01' => { '__HPARAM__' => '', '__PARAM_TYPE__' => '2', '__PARAM_PREFIX__' => '-n', '__PARAM_DESCR__' => 'IP', '__PARAM_VALUE__' => '', '__SCRIPT__' => $linux_metric_wmi_EventLog::SCRIPT_NAME },
		'p02' => { '__HPARAM__' => '', '__PARAM_TYPE__' => '0', '__PARAM_PREFIX__' => '-u', '__PARAM_DESCR__' => 'User', '__PARAM_VALUE__' => '', '__SCRIPT__' => $linux_metric_wmi_EventLog::SCRIPT_NAME },
		'p03' => { '__HPARAM__' => '', '__PARAM_TYPE__' => '1', '__PARAM_PREFIX__' => '-p', '__PARAM_DESCR__' => 'Clave', '__PARAM_VALUE__' => '', '__SCRIPT__' => $linux_metric_wmi_EventLog::SCRIPT_NAME },
	...
	# ----------------------------
	'__TIP__'  => {
		'__DESCR_TIP__' => 'Este script permite obtener valores de la clase WMI Win32_NTEventLogFile. Sus parámetros de ejecución son:
cnm@cnm:/opt/cnm/xagent/base# ./linux_metric_wmi_EventLog.pl -h
linux_metric_wmi_EventLog.pl 1.0

linux_metric_wmi_EventLog.pl -n IP -u user -p pwd -d domain
linux_metric_wmi_EventLog.pl -n IP -u domain/user -p pwd
linux_metric_wmi_EventLog.pl -h  : Ayuda
...
-d    Dominio
',
		'__ID_REF__' => $linux_metric_wmi_EventLog::SCRIPT_NAME
	}
);
...
@linux_metric_wmi_EventLog::METRICS = (
	...
	{ 
		...
		'__PARAMS_DESCR__'=> '',
		'__SCRIPT__'=> $linux_metric_wmi_EventLog::SCRIPT_NAME, 	'__SEVERITY__'=> '1', 	'__CFG__'=> '1',
	   ...
	   '__METRIC_PARAMS__' => {
   	   ...
   	   'p01' => { '__ENABLE__' => '1', '__VALUE__' => '', '__SCRIPT__' => $linux_metric_wmi_EventLog::SCRIPT_NAME },
   	   'p02' => { '__ENABLE__' => '1', '__VALUE__' => '$sec.wmi.user', '__SCRIPT__' => $linux_metric_wmi_EventLog::SCRIPT_NAME },
   	   'p03' => { '__ENABLE__' => '1', '__VALUE__' => '$sec.wmi.pwd', '__SCRIPT__' => $linux_metric_wmi_EventLog::SCRIPT_NAME },
      },
		# ----------------------------
	   '__TIP__'  => {
   	   '__DESCR_TIP__' => 'Métrica que monitoriza el numero de registros almacenados en el Visor de Eventos a partir del atributo <strong>NumberOfRecords</strong> de la clase WMI <strong>Win32_NTEventLogFile</strong>.
...
#|            18 | EXCESO DE EVENTOS                | s_xagt_647cba-d30a2710     | v1>1000   | NULL   |        2 | xagt_647cba     | xagent | xagt_647cba     |     0 | proxy-linux        |
	...
	#------------------------------------------------------------------------
   {
      ...
      # ----------------------------
      '__TIP__'  => {
         '__DESCR_TIP__' => 'Métrica que monitoriza el tamaño del fichero del Visor de Eventos a partir del atributo <strong>FileSize</strong> de la clase WMI <strong>Win32_NTEventLogFile</strong>.
Es válida para sistemas Windows',
      }
...
#---------------------------------------------------------------------------
#---------------------------------------------------------------------------
%linux_metric_wmi_EventLog::APPS = (
