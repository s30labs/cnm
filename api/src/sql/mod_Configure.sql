...
*/
			...
			'all_credentials_real'=> "SELECT id_credential,pwd,descr,type,user,port,name FROM credentials where type IN ('ssh','telnet','wmi','cifs','vmware','syslog-local2','syslog-local3','syslog-local4','syslog-filters','ipmi','api')",
