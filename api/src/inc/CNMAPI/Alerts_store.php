...
// curl -ki -H "Authorization: 5cbe57d976f99dc436f82653ce6d1314" "https://localhost/onm/api/1.0/alerts_store.json"
// Para obtener una alerta concreta:
// curl -ki -H "Authorization: 5cbe57d976f99dc436f82653ce6d1314" "https://localhost/onm/api/1.0/alerts_store/17645.json"
// ------------------------------------------------------------------------------

function api_get_alerts_store($id=0) {
   include_once('inc/class.cnmlist.php');

   $list = New cnmlist('alerts_store');
...
/*
function api_get_alerts_store($id) {
   $extra_params = array();
...
URL: http://10.2.254.222/onm/api/alerts/get.php?PHPSESSID=56eadf6d5ad2f270035576447466a555&params={"devicename":"cnm-devel"}
   ...
   $table  = common_alerts_store_get_table(3,$params,$extra_params);
...
// ------------------------------------------------------------------------------
// api_delete_alerts_store
// ------------------------------------------------------------------------------
// IN: 	id (Id de la alerta)
// OUT:	Array con el resultado
// ------------------------------------------------------------------------------
// Para obtener una alerta concreta:
// curl -ki -H "Authorization: 5cbe57d976f99dc436f82653ce6d1314" -X DELETE "https://localhost/onm/api.0/alerts_store/12.json"
// ------------------------------------------------------------------------------
function api_delete_alerts_store($id) {
   include_once('inc/class.cnmalert_store.php');

   $a_res = cnmalert_store::del($id);
   return $a_res;
}
?>
