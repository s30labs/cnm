<?php
      $TIPS[]=array(
         'id_ref' => 'ASYNCOS-MAIL-MIB::resourceConservationMode',  'tip_type' => 'remote', 'url' => '',
...
<br>INTEGER {noResourceConservation(1), memoryShortage(2), queueSpaceShortage(3), queueFull(4)} 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'ASYNCOS-MAIL-MIB::powerSupplyStatusChange',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>INTEGER {powerSupplyNotInstalled(1), powerSupplyHealthy(2), powerSupplyNoAC(3), powerSupplyFaulty(4)} 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'ASYNCOS-MAIL-MIB::highTemperature',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'ASYNCOS-MAIL-MIB::fanFailure',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'ASYNCOS-MAIL-MIB::keyExpiration',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'ASYNCOS-MAIL-MIB::updateFailure',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'ASYNCOS-MAIL-MIB::raidStatusChange',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
