<?php
      $TIPS[]=array(
         'id_ref' => 'PAN-TRAPS::panThreatTrap',  'tip_type' => 'remote', 'url' => '',
...
<br>OCTET STRING (1..32) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PAN-TRAPS::panGeneralGeneralTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (1..512) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PAN-TRAPS::panGeneralSystemShutdownTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (1..512) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PAN-TRAPS::panHWDiskErrorsTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (1..512) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PAN-TRAPS::panHAHa1LinkChangeTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (1..512) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PAN-TRAPS::panHAHa2LinkChangeTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (1..512) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PAN-TRAPS::panHADataplaneDownTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (1..512) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PAN-TRAPS::panHAPolicyPushFailTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (1..512) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PAN-TRAPS::panHAConnectChangeTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (1..512) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PAN-TRAPS::panHAPathMonitorDownTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (1..512) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PAN-TRAPS::panHALinkMonitorDownTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (1..512) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PAN-TRAPS::panHAPeerSyncFailureTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (1..512) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PAN-TRAPS::panHAConfigFailureTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (1..512) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PAN-TRAPS::panHAPeerErrorTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (1..512) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PAN-TRAPS::panHAPeerVersionUnsupportedTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (1..512) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PAN-TRAPS::panHAPeerVersionDegradedTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (1..512) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PAN-TRAPS::panHAPeerCompatMismatchTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (1..512) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PAN-TRAPS::panHAPeerCompatFailTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (1..512) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PAN-TRAPS::panHAPeerShutdownTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (1..512) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PAN-TRAPS::panHANfsPanlogsFailTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (1..512) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PAN-TRAPS::panHAInternalHaErrorTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (1..512) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PAN-TRAPS::panHAStateChangeTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (1..512) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'PAN-TRAPS::panHANonFunctionalLoopTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
