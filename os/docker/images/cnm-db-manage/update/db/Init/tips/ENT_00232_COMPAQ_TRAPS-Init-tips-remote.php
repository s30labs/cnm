<?php
      $TIPS[]=array(
         'id_ref' => 'CPQCLUSTER-MIB::cpqClusterNodeDegraded',  'tip_type' => 'remote', 'url' => '',
...
<br>OCTET STRING (0..64) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQCLUSTER-MIB::cpqClusterFailed',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQCLUSTER-MIB::cpqClusterDegraded',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"This trap will be sent any time the condition of the cluster
              becomes degraded."
v1: <strong>sysName</strong><br><br><br>v2: <strong>cpqHoTrapFlags</strong><br><br><br>v3: <strong>cpqClusterName</strong><br>"The name of the cluster."
<br>OCTET STRING (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQCLUSTER-MIB::cpqClusterNodeFailed',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"This trap will be sent any time the condition of a node in
...
<br>OCTET STRING (0..64) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQCLUSTER-MIB::cpqClusterResourceDegraded',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>OCTET STRING (0..64) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQCLUSTER-MIB::cpqClusterResourceFailed',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"This trap will be sent any time the condition of a cluster
...
<br>OCTET STRING (0..64) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQCLUSTER-MIB::cpqClusterNetworkDegraded',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"This trap will be sent any time the condition of a cluster
...
<br>OCTET STRING (0..64) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHeThermalTempFailed',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHeThermalTempDegraded',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>INTEGER {other(1), continue(2), shutdown(3)} 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHeThermalTempOk',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHeThermalSystemFanFailed',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHeThermalSystemFanDegraded',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHeThermalSystemFanOk',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHeThermalCpuFanFailed',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHeThermalCpuFanOk',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHePostError',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHeFltTolPwrSupplyDegraded',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3ThermalTempFailed',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"The temperature status has been set to failed.
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3ThermalTempDegraded',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"The temperature status has been set to degraded.
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3ThermalTempOk',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"The temperature status has been set to ok.
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3ThermalSystemFanFailed',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"The system fan status has been set to failed.
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3ThermalSystemFanDegraded',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"The system fan status has been set to degraded.
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3ThermalSystemFanOk',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"The system fan status has been set to ok.
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3ThermalCpuFanFailed',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"The CPU fan status has been set to failed.
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3ThermalCpuFanOk',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"The CPU fan status has been set to ok.
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3PostError',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"One or more POST errors occurred.
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3FltTolPwrSupplyDegraded',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"The fault tolerant power supply sub-system condition has been
              set to degraded."
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3FltTolPowerSupplyDegraded',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3FltTolPowerSupplyFailed',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"The fault tolerant power supply condition has been set
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3FltTolPowerRedundancyLost',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3FltTolPowerSupplyInserted',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3FltTolPowerSupplyRemoved',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3FltTolFanDegraded',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3FltTolFanFailed',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3FltTolFanRedundancyLost',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3FltTolFanInserted',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3FltTolFanRemoved',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3TemperatureFailed',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3TemperatureDegraded',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3TemperatureOk',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3PowerConverterDegraded',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3PowerConverterFailed',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3PowerConverterRedundancyLost',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3CacheAccelParityError',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHeResilientMemOnlineSpareEngaged',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe4FltTolPowerSupplyOk',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe4FltTolPowerSupplyDegraded',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"The fault tolerant power supply condition has been set
             to degraded for the specified chassis and bay location."
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe4FltTolPowerSupplyFailed',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"The fault tolerant power supply condition has been set
             to failed for the specified chassis and bay location."
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHeResilientMemMirroredMemoryEngaged',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHeResilientAdvancedECCMemoryEngaged',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHeResilientMemXorMemoryEngaged',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3FltTolPowerRedundancyRestored',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe3FltTolFanRedundancyRestored',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHe4CorrMemReplaceMemModule',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHeResMemBoardRemoved',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHeResMemBoardInserted',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQHLTH-MIB::cpqHeResMemBoardBusError',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDaLogDrvStatusChange',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>INTEGER {other(1), ok(2), failed(3), unconfigured(4), recovering(5), readyForRebuild(6), rebuilding(7), wrongDrive(8), badConnect(9), overheating(10), shutdown(11), expanding(12), notAvailable(13), queuedForExpansion(14), multipathAccessDegraded(15), erasing(16)} 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDaSpareStatusChange',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>INTEGER
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDaPhyDrvStatusChange',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>INTEGER
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDaPhyDrvThreshPassedTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>INTEGER
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDaAccelStatusChange',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>INTEGER {other(1), invalid(2), enabled(3), tmpDisabled(4), permDisabled(5)} 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDaAccelBadDataTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>INTEGER {other(1), none(2), possible(3)} 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDaAccelBatteryFailed',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>INTEGER {other(1), ok(2), recharging(3), failed(4), degraded(5), notPresent(6), capacitorFailed(7)} 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa2LogDrvStatusChange',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Logical Drive Status Change.
...
<br>INTEGER {other(1), ok(2), failed(3), unconfigured(4), recovering(5), readyForRebuild(6), rebuilding(7), wrongDrive(8), badConnect(9), overheating(10), shutdown(11), expanding(12), notAvailable(13), queuedForExpansion(14), multipathAccessDegraded(15), erasing(16)} 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa3SpareStatusChange',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Spare Drive Status Change.
...
<br>INTEGER
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa2SpareStatusChange',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Spare Drive Status Change.
...
<br>INTEGER
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa2PhyDrvStatusChange',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Physical Drive Status Change.
...
<br>INTEGER
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa2PhyDrvThreshPassedTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Physical Drive Threshold Passed.
...
<br>INTEGER
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa2AccelStatusChange',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Accelerator Board Status Change.
...
<br>INTEGER {other(1), invalid(2), enabled(3), tmpDisabled(4), permDisabled(5)} 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa2AccelBadDataTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Accelerator Board Bad Data.
...
<br>INTEGER {other(1), none(2), possible(3)} 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa2AccelBatteryFailed',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Accelerator Board Battery Failed.
...
<br>INTEGER {other(1), ok(2), recharging(3), failed(4), degraded(5), notPresent(6), capacitorFailed(7)} 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa3LogDrvStatusChange',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Logical Drive Status Change.
...
<br>INTEGER {other(1), ok(2), failed(3), unconfigured(4), recovering(5), readyForRebuild(6), rebuilding(7), wrongDrive(8), badConnect(9), overheating(10), shutdown(11), expanding(12), notAvailable(13), queuedForExpansion(14), multipathAccessDegraded(15), erasing(16)} 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa3PhyDrvStatusChange',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Physical Drive Status Change.
...
<br>INTEGER
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa3PhyDrvThreshPassedTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Physical Drive Threshold Passed.
...
<br>INTEGER
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa3AccelStatusChange',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Accelerator Board Status Change.
...
<br>INTEGER {other(1), invalid(2), enabled(3), tmpDisabled(4), permDisabled(5)} 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa3AccelBadDataTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Accelerator Board Bad Data.
...
<br>INTEGER {other(1), none(2), possible(3)} 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa3AccelBatteryFailed',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Accelerator Board Battery Failed.
...
<br>INTEGER {other(1), ok(2), recharging(3), failed(4), degraded(5), notPresent(6), capacitorFailed(7)} 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDaCntlrStatusChange',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>INTEGER {other(1), ok(2), generalFailure(3), cableProblem(4), poweredOff(5)} 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDaCntlrActive',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>INTEGER
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa4SpareStatusChange',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Spare Drive Status Change.
...
<br>INTEGER (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa4PhyDrvStatusChange',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Physical Drive Status Change.
...
<br>INTEGER (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa4PhyDrvThreshPassedTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Physical Drive Threshold Passed.
...
<br>INTEGER (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa5AccelStatusChange',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Accelerator Board Status Change.
...
<br>INTEGER {other(1), invalid(2), badConfig(3), lowBattery(4), disableCmd(5), noResources(6), notConnected(7), badMirrorData(8), readErr(9), writeErr(10), configCmd(11), expandInProgress(12), snapshotInProgress(13), redundantLowBattery(14), redundantSizeMismatch(15), redundantCacheFailure(16), excessiveEccErrors(17), adgEnablerMissing(18), postEccErrors(19), batteryHotRemoved(20), capacitorChargeLow(21), notEnoughBatteries(22), cacheModuleNotSupported(23), batteryNotSupported(24), noCapacitorAttached(25), capBasedBackupFailed(26), capBasedRestoreFailed(27), capBasedModuleHWFailure(28), capacitorFailedToCharge(29)} 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa5AccelBadDataTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Accelerator Board Bad Data.
...
<br>INTEGER
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa5AccelBatteryFailed',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Accelerator Board Battery Failed.
...
<br>INTEGER
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa5CntlrStatusChange',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Controller Status Change.
...
<br>INTEGER
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa5PhyDrvStatusChange',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Physical Drive Status Change.
...
<br>INTEGER
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa5PhyDrvThreshPassedTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Physical Drive Threshold Passed.
...
<br>OCTET STRING (0..40) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa6CntlrStatusChange',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Controller Status Change.
...
<br>INTEGER
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa6LogDrvStatusChange',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Logical Drive Status Change.
...
<br>INTEGER {other(1), ok(2), failed(3), unconfigured(4), recovering(5), readyForRebuild(6), rebuilding(7), wrongDrive(8), badConnect(9), overheating(10), shutdown(11), expanding(12), notAvailable(13), queuedForExpansion(14), multipathAccessDegraded(15), erasing(16)} 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa6SpareStatusChange',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Spare Drive Status Change.
...
<br>INTEGER (0..255) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa6PhyDrvStatusChange',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Physical Drive Status Change.
...
<br>INTEGER {other(1), ok(2), failed(3), predictiveFailure(4), erasing(5), eraseDone(6), eraseQueued(7)} 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa6PhyDrvThreshPassedTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Physical Drive Threshold Passed.
...
<br>OCTET STRING (0..40) 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa6AccelStatusChange',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Accelerator Board Status Change.
...
<br>INTEGER {other(1), invalid(2), badConfig(3), lowBattery(4), disableCmd(5), noResources(6), notConnected(7), badMirrorData(8), readErr(9), writeErr(10), configCmd(11), expandInProgress(12), snapshotInProgress(13), redundantLowBattery(14), redundantSizeMismatch(15), redundantCacheFailure(16), excessiveEccErrors(17), adgEnablerMissing(18), postEccErrors(19), batteryHotRemoved(20), capacitorChargeLow(21), notEnoughBatteries(22), cacheModuleNotSupported(23), batteryNotSupported(24), noCapacitorAttached(25), capBasedBackupFailed(26), capBasedRestoreFailed(27), capBasedModuleHWFailure(28), capacitorFailedToCharge(29)} 
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa6AccelBadDataTrap',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Accelerator Board Bad Data.
...
<br>INTEGER
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa6AccelBatteryFailed',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
...
<br>INTEGER
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa7PhyDrvStatusChange',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Physical Drive Status Change.
...
<br>INTEGER
   <br>',
      ...
      $TIPS[]=array(
         'id_ref' => 'CPQIDA-MIB::cpqDa7SpareStatusChange',  'tip_type' => 'remote', 'url' => '',
         'date' => '',     'tip_class' => 1, 'name' => 'CNM-Info',
         'descr' => '"Spare Drive Status Change.
