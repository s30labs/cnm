...
//---------------------------------------------------------------------------------------------------------
// Metrica de tipo SNMP ('tip_type' =>'cfg')
// El id_ref coincide con el subtype de la metrica de tipo snmp 
//---------------------------------------------------------------------------------------------------------

	   $TIPS[]=array(
         'id_ref' => 'disk_mibhost',	'tip_type' =>'cfg' ,	'url' => '',
      ...
      $TIPS[]=array(
         'id_ref' => 'disk_mibhostp',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,    'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'proc_cnt_mibhost',	'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'users_cnt_mibhost',	'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'esp_cpu_mibhost',	'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
         'descr' => '',
      ...
      $TIPS[]=array(
         'id_ref' => 'esp_cpu_avg_mibhost',	'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'traffic_mibii_if',	'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'traffic_mibii_if_hc',  'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'pkts_type_mibii_if',	'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'pkts_type_mibii_if_ext',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'pkts_type_mibrmon',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'ip_pkts_discard',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'tcp_estab',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'tcp_ap',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'udp_pkts',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'esp_arp_mibii_cnt',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'pkts_discard_mibii_if',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'errors_mibii_if',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'status_mibii_if',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
...
UNK (naranja) : Resto',
      ...
      $TIPS[]=array(
         'id_ref' => 'nortel_memory',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'nortel_cpu',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'cisco_memory',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'cisco_cpu',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'cisco_buffer_usage',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'cisco_buffer_errors',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'cisco_ds0_usage',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'cisco_ds0_errors',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'cisco_modem_usage',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'cisco_modem_errors',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'cisco_wap_users',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'enterasys_cpu_usage',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'enterasys_flow3',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'enterasys_flow2',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'brocade_frames_port',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'brocade_status_port',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
         'descr' => 'Mide el <strong>estado de los puertos Fiber Channel</strong> a partir de los siguientes atributos de la MIB SW-MIB:<br><br><strong>SW-MIB::swFCPortAdmStatus (Integer { unknown(0); online(1), offline(2), testing(3), faulty(4) })</strong>The desired state of the port.<br><strong>SW-MIB::swFCPortOpStatus (Integer { unknown(0), online(1), offline(2), testing(3), faulty(4) })</strong>Identifies the operational status of the port.',
      );
      $TIPS[]=array(
         'id_ref' => 'novell_nw_fs_read_write',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'novell_nw_fs_cache',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'novell_nw_open_files',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'novell_nw_disk_usage',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
...
<br><strong>NetWare-Server-MIB::nwVolFreeable (Integer32)</strong>The amount of freeable space (in KBytes) being used by previously deleted files on this volume. The freeable space can be reclaimed as free space by purging deleted files.',
      ...
      $TIPS[]=array(
         'id_ref' => 'novell_nw_disk_dir',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'checkpoint_numconex',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'checkpoint_peakconex',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'ucdavis_interrupts',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'ucdavis_cpu',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'httpserver_files_sent',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'httpserver_current_users',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'httpserver_total_users',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'httpserver_max_users',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'httpserver_current_connections',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'httpserver_connections',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'httpserver_request_type1',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'httpserver_request_type2',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'httpserver_error_notfound',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'fortinet_cpu_usage',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'fortinet_memory_usage',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'fortinet_net_usage',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'fortinet_active_sessions',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'fortinet_packets',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'fortinet_bytes',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'fortinet_attacks',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'fortinet_virus',   'tip_type' =>'cfg' , 'url' => '',
         'date' => '',     'tip_class' => 1,  'name' => 'Descripcion',
