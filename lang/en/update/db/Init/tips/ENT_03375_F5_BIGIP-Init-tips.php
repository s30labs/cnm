...
',
	...
	$TIPS[]=array(
		'id_ref' => 'f5big_cpu_temp',
		'tip_type' => 'cfg',
		'name' => 'Descripcion',
		'descr' => 'Mide: <strong>sysCpuTemperature</strong> a partir de los siguientes atributos de la mib F5-BIGIP-SYSTEM-MIB:<br><br><strong>F5-BIGIP-SYSTEM-MIB::sysCpuTemperature (GAUGE):</strong> "The temperature of the indexed CPU on the system. 
...
',
	...
	$TIPS[]=array(
		'id_ref' => 'f5big_cpu_fans',
		'tip_type' => 'cfg',
		'name' => 'Descripcion',
		'descr' => 'Mide: <strong>sysCpuFanSpeed</strong> a partir de los siguientes atributos de la mib F5-BIGIP-SYSTEM-MIB:<br><br><strong>F5-BIGIP-SYSTEM-MIB::sysCpuFanSpeed (GAUGE):</strong> "The fan speed (in RPM) of the indexed CPU on the system.,
 		This is only supported for the platform where 
 		the sensor data is available."
',
	);
