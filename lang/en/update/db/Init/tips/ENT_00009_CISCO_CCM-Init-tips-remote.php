<?
	$TIPS[]=array(
		'id_ref' => 'CISCO-CCM-MIB::ccmCallManagerFailed',
		'tip_type' => 'remote',
		'name' => 'CNM-Info',
...
<br>INTEGER {unknown(1), heartBeatStopped(2), routerThreadDied(3), timerThreadDied(4), criticalThreadDied(5), deviceMgrInitFailed(6), digitAnalysisInitFailed(7), callControlInitFailed(8), linkMgrInitFailed(9), dbMgrInitFailed(10), msgTranslatorInitFailed(11), suppServicesInitFailed(12)} 
   <br>',
	...
	$TIPS[]=array(
		'id_ref' => 'CISCO-CCM-MIB::ccmPhoneFailed',
		'tip_type' => 'remote',
		'name' => 'CNM-Info',
...
<br>Unsigned32
   <br>',
	...
	$TIPS[]=array(
		'id_ref' => 'CISCO-CCM-MIB::ccmPhoneStatusUpdate',
		'tip_type' => 'remote',
		'name' => 'CNM-Info',
		'descr' => '"This Notification will be generated in the intervals 
...
<br>Unsigned32
   <br>',
	...
	$TIPS[]=array(
		'id_ref' => 'CISCO-CCM-MIB::ccmGatewayFailed',
		'tip_type' => 'remote',
		'name' => 'CNM-Info',
...
<br>INTEGER {noError(0), unknown(1), noEntryInDatabase(2), databaseConfigurationError(3), deviceNameUnresolveable(4), maxDevRegReached(5), connectivityError(6), initializationError(7), deviceInitiatedReset(8), callManagerReset(9)} 
   <br>',
	...
	$TIPS[]=array(
		'id_ref' => 'CISCO-CCM-MIB::ccmMediaResourceListExhausted',
		'tip_type' => 'remote',
		'name' => 'CNM-Info',
...
<br>OCTET STRING (0..128) 
   <br>',
	...
	$TIPS[]=array(
		'id_ref' => 'CISCO-CCM-MIB::ccmRouteListExhausted',
		'tip_type' => 'remote',
		'name' => 'CNM-Info',
...
<br>OCTET STRING (0..128) 
   <br>',
	...
	$TIPS[]=array(
		'id_ref' => 'CISCO-CCM-MIB::ccmGatewayLayer2Change',
		'tip_type' => 'remote',
		'name' => 'CNM-Info',
