...
',
	...
	$TIPS[]=array(
		'id_ref' => 'finjan_sum_log',
		'tip_type' => 'cfg',
		'name' => 'Descripcion',
		'descr' => 'Mide: <strong>vsSummaryLogged-total.0</strong> a partir de los siguientes atributos de la mib FINJAN-MIB:<br><br><strong>FINJAN-MIB::vsSummaryLogged-total.0 (GAUGE):</strong> ',
	);

	$TIPS[]=array(
		'id_ref' => 'finjan_det_log',
		'tip_type' => 'cfg',
		'name' => 'Descripcion',
